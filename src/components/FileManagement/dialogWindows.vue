      ...
      >
        <div>
          <div style="display: flex;justify-content: space-between;">
            ...
            <div>
              <el-alert title="点击图片确定才能选中图片" type="success" effect="dark" :closable="false"/>
            </div>
            <div>
              <el-tooltip
                class="box-item"
          ...
          <div  style="border: 10rpx solid red;margin: 20px;overflow-y:scroll;position:reactive;bottom:30px;height: 600px;">
            ...
            <div v-if="FileList.length" class="common-layout" style="">
              <el-container>
        ...
        <template #footer>
          ...
          <span class="dialog-footer" style="position: relative;top:10px">
            <el-button @click="onCancel('quit')">{{ close_title }}</el-button>
            <el-button type="primary" @click="onCancel('queding')">
              {{ button_title }}
            </el-button>
          </span>
        </template>
...
const props = withDefaults(
  ...
  }>(),
  {
    ...
    close_title:'关闭',
    data:{},
    url:'https://api.daccf.com/api/file/uploadFile'
  }
);
...
const dialogVisibles:any = props.dialogVisible
