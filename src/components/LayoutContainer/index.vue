...
<template>
  <div class="flex-container">
    ...
    <div class="main">
      <el-icon v-if="enabledLeftSide && !hideLeftSideToggle" class="left-side-icon" @click="leftSideVisiable = !leftSideVisiable">
        <svg-icon :name="leftSideVisiable ? 'i-ep:caret-left' : 'i-ep:caret-right'" />
      </el-icon>
      <el-icon v-if="enabledRightSide && !hideRightSideToggle" class="right-side-icon" @click="rightSideVisiable = !rightSideVisiable">
