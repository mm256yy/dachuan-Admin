  ...
  dianpu: [
    {
      ...
      label: "smallRoutine",
      relationship:
        "<div>设置店铺对外展示的名称，该名称建议尽量简短.</div><div>不宜设置太长(最好控制在10个字以内).</div>",
      isEdit: false,
    },
    {
      name: "店铺Logo",
  ...
  <div>
    <page-main>
      <div class="setting-list">
        <page-main title="">
          <el-table :data="wx_form.dianpu" :style="{ width: '100%' }">
            <el-table-column label="店铺信息" :style="{ width: '20%' }">
            ...
            <el-table-column label="当前设置" :style="{ width: '20%' }">
              <template #default="scope">
                <el-input
            ...
            <el-table-column label="说明" :style="{ width: '60%' }">
              <template #default="scope">
