                  ...
                  <template v-else>
                    <!-- <el-button type="primary" plain size="small" @click="scope.row.isEdit = true">
                      ...
                      <div v-if="
                        ...
                        <el-button v-if="scope.row.mobile" @click="upload(scope.row)" type="primary" plain size="small">
                           重新上传
                        </el-button>

                        <el-button v-else @click="upload(scope.row)" type="primary" plain size="small">
                           上传
                        </el-button>
