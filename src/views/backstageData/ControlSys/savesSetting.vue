  ...
  var b: any = {
    ...
    configJson: `{
            ...
            "weiXinConfig":{
              ...
              "g_encodingAESKey":"${wx_form.value.familyMember[10].mobile || 0}"
            },
      ...
      <div class="setting-list">
        <page-main title="">
          <div style="display: flex">
            <el-radio-group v-model="wx_form.cunchu_show" class="ml-4">
              <el-radio
                label="1"
                size="large"
                style="
                ...
                "
              >
                <div style="font-size: 14px">七牛云存储</div></el-radio
              >
              <el-radio
                label="2"
                disabled
                ...
                style="
                  ...
                  border-radius: 8px;
                "
                ><div style="font-size: 14px">阿里云存储</div></el-radio
              >
            </el-radio-group>
          </div>
          <el-table
            ...
            style="margin: 20px 0"
          >
            <el-table-column label="存储信息">
              <template #default="scope">
                <span>{{ scope.row.name }}</span>
              </template>
            </el-table-column>
            <el-table-column label="当前设置">
              <template #default="scope">
                <el-input
                ...
                />
                <div v-else>
                  <span v-if="scope.row.data != 0" style="color: green">
                    已设置
                  </span>
            ...
            <el-table-column label="说明">
              <template #default="scope">
                ...
                <div v-html="scope.row.relationship"></div>
              </template>
            </el-table-column>
