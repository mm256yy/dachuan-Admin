    ...
    <div class="content">
      ...
      <div class="main">
        ...
        >
          ...
          <el-table-column prop="className" label="克隆账号" align="center" />

          <el-table-column prop="gradeId" label="克隆数据	" align="center">
          ...
          <el-table-column prop="gradeId" label="备注信息		" align="center">
            <template #default="scope">
              <div v-if="scope.row.practiceGrade">
                {{ scope.row.practiceGrade.gradeName }}
              </div>
          ...
          <el-table-column
            ...
            align="center"
          /> -->
          <el-table-column prop="createTime" label="克隆时间" align="center" />
...
const delPlugin = () => {
  ...
  ElMessageBox.confirm(`确认删除吗？`, "确认信息")
    .then(() => {
      api.post("/api/plugs/delPlugsPracticeClass", data).then((res: any) => {
        if (res.code == 200) {
          ElMessage.success({
            message: res.msg,
            center: true,
