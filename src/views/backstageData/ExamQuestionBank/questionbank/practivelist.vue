    ...
    <div class="content">
      ...
      <div class="main">
        ...
        >
          ...
          <el-table-column prop="studentName" label="练习用户" align="center" />
...
function getlist() {
  ...
  api
    .get("/api/plugs/searchPlugsPracticeStudentTestRecordList", {
      params: data,
    })
    .then((res: any) => {
      if (res.code == 200) {
...
const delPlugin = () => {
  ...
  ElMessageBox.confirm(`确认删除吗？`, "确认信息")
    .then(() => {
      api
        .post("/api/plugs/delPlugsPracticeStudentTestRecord", data)
        .then((res: any) => {
          if (res.code == 200) {
            ElMessage.success({
              message: res.msg,
