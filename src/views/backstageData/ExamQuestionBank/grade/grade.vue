    ...
    <div class="content">
      ...
      <div class="main">
        ...
        >
          ...
          <el-table-column prop="gradeOrder" label="年级排序" align="center" />
          ...
          <el-table-column prop="status" label="年级状态" align="center">
...
const delPlugin = () => {
  ...
  ElMessageBox.confirm(`确认删除吗？`, "确认信息")
    .then(() => {
      api.post("/api/plugs/delPlugsPracticeGrade", data).then((res: any) => {
        if (res.code == 200) {
          ElMessage.success({
            message: res.msg,
            center: true,
