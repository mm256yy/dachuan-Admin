    ...
    <div class="content" style="border-radius: 10px">
      ...
      <div class="main">
        ...
        >
          ...
          <el-table-column prop="studentName" label="学员名称" align="center" />
          <el-table-column prop="cardNo" label="证件号码" align="center" />
          ...
          <el-table-column
            ...
            align="center"
          />
          <el-table-column prop="validity" label="有效期至" align="center" />
...
function getlist() {
  ...
  api
    .get("/api/plugs/searchPlugsPracticeStudentList", { params: data })
    .then((res: any) => {
      if (res.code == 200) {
...
const delPlugin = () => {
  ...
  ElMessageBox.confirm(`确认删除吗？`, "确认信息")
    .then(() => {
      api.post("/api/plugs/delPlugsPracticeStudent", data).then((res: any) => {
        if (res.code == 200) {
          ElMessage.success({
            message: res.msg,
            center: true,
