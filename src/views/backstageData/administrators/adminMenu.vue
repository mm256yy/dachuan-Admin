      ...
      >
        <el-table-column type="expand">
          <template #default="props">
            <div m="4">
              <el-table
                :data="props.row.menusList"
                :border="childBorder"
                v-if="props.row.menusList.length"
              >
    ...
    >
      <div style="padding: 20px">
        <div style="display: flex; align-items: center; margin: 10px">
          ...
          <el-input
            style="width: 260px"
            v-model="data.menuList.menuName"
            placeholder="菜单名称"
            v-if="userinfo.id == 31"
          />
          <el-input
        ...
        >
          <div style="width: 100px">
            <span style="color: black">*</span> 路径:
          </div>
          <el-input
            style="width: 260px"
        ...
        >
          <div style="width: 100px">
            <span style="color: black">*</span> 路由名:
          </div>
          <el-input
            style="width: 260px"
        ...
        >
          <div style="width: 100px">
            <span style="color: black">*</span> 参数:
          </div>
          <el-input
            style="width: 260px"
        ...
        <div style="display: flex; align-items: center; margin: 10px">
          <div style="width: 100px">
            <span style="color: black">*</span> 是否启用:
          </div>
          <el-switch
...
const listMenu = () => {
  ...
  api
    .get("/api/admin/searchPowerMenusList", { params: data })
    .then((res: any) => {
      let list: any = [];
      if (res.code == 200) {
...
const shot = (item: any) => {
  ...
  if (data.value.menuTitle == "确定") {
    ...
    http
      .post("/api/admin/updatePowerMenus", data.value.menuList)
      .then((res: any) => {
        if (res.code == 200) {
          ElMessage({
            type: "success",
