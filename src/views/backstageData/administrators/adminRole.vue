<route lang="yaml">
  ...
  <template>
    <div class="container">
      <div
        style="background: white;padding: 10px;display: flex;justify-content: space-between;">
        <div></div>
        <div style="display: flex">
          <el-button type="primary" v-if="roleadd.buttonsName && roleadd.id" style="margin-right: 20px" @click="addMenu"
            >添加角色</el-button
          >
      ...
      <div>
        <el-table :data="tableData" :border="parentBorder" style="width: 100%">
          ...
          <el-table-column label="菜单权限" width="110">
            <template #default="scope">
              <div style="display: flex">{{ scope.row.roleMenu.split(',').length }}</div>
            </template>
          </el-table-column>
      ...
      <el-dialog
        ...
        :before-close="handleClose"
      >
        <div style="padding:5px 20px;height: 500px;overflow-y:hidden;overflow-y:scroll">
          <el-checkbox
            v-model="checkAll"
          ...
          <div v-for="item in cities" style="margin-top: 5px;border: 1px solid #eee;padding: 10px;">
            ...
            <el-checkbox-group
              ...
              <el-checkbox  :key="item.id" :label="item.id" >
                  <div style="font-size: 16px;color: black;font-weight: bold;">{{item.menuName}}</div>
              </el-checkbox>
            </el-checkbox-group>
                  ...
                  <div >
                    ...
                    <div v-for="city in item.menusList" style="margin: 10px;">
                      ...
                      <div style="margin: 0px 30px;">
                        ...
                        >
                          <el-checkbox v-for="citys in city.buttonList" :key="citys.id" :label="citys.id">
                            <div style="color:lightskyblue;">{{citys.buttonsName}}</div>
                          </el-checkbox>
                        </el-checkbox-group>
    ...
    api.get('/api/admin/searchPowerMenusList').then((res:any)=>{
      ...
      if(res.code == 200){
        ...
        for (let index = 0; index < menuData.length; index++) {
          ...
          for (let index1 = 0; index1 < menuData[index].menusList.length; index1++) {
