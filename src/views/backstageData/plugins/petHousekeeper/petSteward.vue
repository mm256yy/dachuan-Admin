  ...
  <div style="color:white;">
    ...
    >
      ...
      <el-table-column label="人员名字">
        <template #default="scope" property="name">{{ scope.row.name }}</template>
      </el-table-column>
      ...
      <el-table-column label="头像" align="center" >
        <template #default="scope">
          <img :src="scope.row.headImgUrl" style="height: 64px;width: 64px;border-radius: 6px;border: 1px solid #ccc;">
        </template>
      </el-table-column>
    ...
    >
      <div style="padding:20px;border:1px solid #eee;margin: 10px;display: flex;">
        <div >
          <div style="">
            <div style="margin:2px 0;">
              <span style="color: red;">*</span>
              <span style="font-weight: bolder;color: black;font-size: 14px;">人员名称</span>
            </div>
            <el-input
                style="width: 260px;"
                v-model="form.name"
          ...
          <div style="">
            <div style="margin:2px 0;">
              <span style="color: red;">*</span>
              <span style="font-weight: bolder;color: black;font-size: 14px;">手机号</span>
            </div>
            <el-input
              style="width:260px;"
              type="number"
          ...
          <div style="">
            <div style="margin:2px 0;">
              <span style="color: red;">*</span>
              <span style="font-weight: bolder;color: black;font-size: 14px;">基础价格</span>
            </div>
            <el-input
              style="width: 200px;"
              type="number"
          ...
          <div>
            <div style="margin:2px 0;">
              ...
              <span style="font-weight: bolder;color: black;font-size: 14px;">头像</span>
            </div>
            <!-- <el-upload
            ...
            > -->
              <img @click="upload_image('imageUrl')" v-if="form.headImgUrl" :src="form.headImgUrl" style="width: 64px;height: 64px;border: 1px solid #ccc;border-radius: 6px;" />
              <el-icon @click="upload_image('imageUrl')" v-else style="width: 64px;height: 64px;border: 1px solid #ccc;border-radius: 6px;"><Plus /></el-icon>
            <!-- </el-upload> -->
          ...
          <div>
            <div style="margin:2px 0;">
              <span style="color: red;">*</span>
              <span style="font-weight: bolder;color: black;font-size: 14px;">擅长</span>
            </div>
            <el-input v-model="form.begoodat" placeholder="请输入擅长" style="width:260px"/>
          </div>

          <div >
            <div style="margin:2px 0;">
              <span style="color: red;">*</span>
              <span style="font-weight: bolder;color: black;font-size: 14px;">养过的宠物</span>
            </div>
            <el-input v-model="form.adopterHistory" placeholder="养过的宠物" style="width:260px"/>
          </div>
          <div >
            <div style="margin:2px 0;">
              <span style="color: red;">*</span>
              <span style="font-weight: bolder;color: black;font-size: 14px;">养龄</span>
            </div>
            <el-input
              style="width: 200px;"
              type="number"
          ...
          <div >
            <div style="margin:2px 0;">
              <span style="color: red;">*</span>
              <span style="font-weight: bolder;color: black;font-size: 14px;">职业</span>
            </div>
            <el-input v-model="form.job" placeholder="职业" style="width:260px"/>
          </div>
        </div>
        <div style="margin-left: 20px;">
          <div>
            <div style="margin:2px 0;">
              <span style="color: red;">*</span>
              <span style="font-weight: bolder;color: black;font-size: 14px;">店铺</span>
            </div>
            <div>
                <el-select v-model="value" class="m-2" placeholder="Select"  @change="selectBusi">
                  <el-option
          ...
          <div>
            <div style="margin:2px 0;">
              <span style="color: black;">*</span>
              <span style="font-weight: bolder;color: black;font-size: 14px;">描述</span>
            </div>
            <div>
              <el-input
                style="width: 260px;"
          ...
          <div>
            <div style="margin:2px 0;">
              <span style="color: red;">*</span>
              <span style="font-weight: bolder;color: black;font-size: 14px;">套餐</span>
            </div>
            <div>
              <el-tag
              ...
              <el-button style="margin-left:5px" v-else class="button-new-tag ml-1" size="small" @click="showInput">
                + 添加套餐
              </el-button>
            </div>
          </div>
          ...
          <div style="margin-top: 5px;">
            <div style="margin:2px 0;">
              <span style="color: red;">*</span>
              <span style="font-weight: bolder;color: black;font-size: 14px;">升级套餐</span>
            </div>
            <div>
              <el-tag
              ...
              <el-button  style="margin-left:5px" v-else class="button-new-tag ml-1" size="small" @click="showInput1">
                + 添加升级服务
              </el-button>
            </div>
          </div>
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" @click="shop">
            确定
          </el-button>
        </span>
      </template>
...
import { ElTable,ElMessageBox ,ElMessage,UploadProps,ElInput } from 'element-plus'
...
const getPet = ()=>{
  ...
  api.get('/api/plugs/searchPlugsPetStewardList',{
    params:data
  }).then((res:any)=>{
    if(res.code == 200){
...
const shop = ()=>{
  ...
  if(select_type.value == '新增'){
    ...
    http.post('/api/plugs/insertPlugsPetSteward',form.value).then((res:any)=>{
      console.log(res);
      if(res.code == 200){
    ...
    http.post('/api/plugs/updatePlugsPetSteward',form.value).then((res:any)=>{
      if(res.code == 200){
        dialogVisible.value = false
        ElMessage({
          type:'success',
...
const find = ()=>{
  ...
  if(keyword.value){
    ...
    http.get('/api/plugs/searchPlugsPetStewardById',{
      params:data
    }).then((res:any)=>{
...
const handleInputConfirm = () => {
  ...
  if (inputValue.value && inputValuePrice.value) {
    ...
    dynamicTags.value[dynamicTags.value.length-1].setMealName = inputValue.value
    dynamicTags.value[dynamicTags.value.length-1].money = inputValuePrice.value
    inputVisible.value = false
    inputValue.value = ''
...
if (inputValue1.value && inputValuePrice1.value) {
  ...
  dynamicTags1.value[dynamicTags1.value.length-1].serviceName = inputValue1.value
  dynamicTags1.value[dynamicTags1.value.length-1].money = inputValuePrice1.value
  inputVisible1.value = false
  inputValue1.value = ''
