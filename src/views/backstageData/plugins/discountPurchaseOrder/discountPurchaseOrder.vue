        ...
        <div class="content">
          <div class="header" style="margin-bottom: 20px">
            ...
            <div style="display: flex">
              ...
              <div class="lang" style="display: flex; align-items: center; " >
                <el-date-picker size="default" v-model="value2" @change="changeTime2"
          ...
          <div class="main">
            ...
            >
              ...
              <el-table-column prop="userName" label="用户昵称" align="center" width="100" />
...
function getStoreList(){
  ...
  api.get("/api/plugs/getBusinessInfo", { params: data }).then((res: any) => {
    ...
    //   console.log(data,'routerouteroute88888888888888')
      api
        ...
        // console.log(list,'tableData.value877777777777777')
