		...
		<div class="content">
			<el-form  ref="formRef" :model="form" :rules="formRules" label-width="110px">
				<div>
					...
					<el-form-item label="优惠券类型" prop="couponType">
						...
						<el-select v-model="form.couponType" filterable placeholder="请选择优惠券类型">
							<!-- <el-option key="0" label="全部" value="0" /> -->
							<el-option v-for="item in couponType" :key="item.id" :label="item.name"
								:value="item.id" />
						</el-select>
					</el-form-item>
            ...
            >
              ...
              />
					...
					<el-form-item v-if="form.couponType==0 || form.couponType==1" label="优惠券面额" prop="couponDenomination">
					  <el-input
					    style="width: 240px"
					...
					<el-form-item v-if="form.couponType==2" label="积分优惠券" prop="couponDenomination">
					  <el-input
					    style="width: 240px"
					    v-model="form.couponDenomination"
					    placeholder="积分值"
					...
					<el-form-item v-if="form.couponType==3" label="折扣优惠券" prop="couponDenomination">
					  <el-input
					    style="width: 240px"
					    v-model="form.couponDenomination"
					    placeholder="折扣值0~1"
					...
					<el-form-item v-if="form.couponType!==2" label="满多少元使用" prop="howMuchFullMoney">
					  <el-input
					    style="width: 240px"
					...
					<el-form-item v-if="form.couponType==1" label="优惠券口令" prop="couponPassword">
					  <el-input
					    style="width: 460px"
					...
					<el-form-item label="有效时间" prop="timeType">
							<el-radio-group @change="dateType" v-model="form.timeType" class="ml-4">
							      <el-radio :label="1" size="large">固定日期</el-radio>
							      <el-radio :label="2" size="large">领取到当日开始N天内有效</el-radio>
							</el-radio-group>
					</el-form-item>
					<el-form-item v-if="form.timeType==1" label="" prop="startTime">
							<span style="margin-right: 8px;" class="demonstration">生效日期:</span>
							  <el-date-picker
									@change="startTime"
							          v-model="value1"
							          type="datetime"
					...
					<el-form-item v-if="form.timeType==1" label="" prop="endTime">
							<span style="margin-right: 8px;" class="demonstration" >过期日期:</span>
							  <el-date-picker
							          v-model="value2"
									  @change="endTime"
							          type="datetime"
					...
					<el-form-item label="可使用商品" prop="goodsType">
							<el-radio-group @change="selectGoods" v-model="form.goodsType" class="ml-4">
...
function selectBusiness(val:any){
  ...
  // form.value.businessId=realSelect.toString();
	...
	function startTime(){
		...
		// console.log(form.value,'生效日期生效日期生效日期')
	}
	// 过期日期
	function endTime(){
