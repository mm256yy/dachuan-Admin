...
const weiXinConfig = () => {
  api
    .get("/api/plugs/apiGetAuthorizerInfoUrl", {
      params: {
    ...
    .then((res: any) => {
      ...
      if (res.code == 200) {
        ...
        info.value.authorizer_info.qrcode_url = String(
          info.value.authorizer_info.qrcode_url
        ).replace("/qrImg", "");
        ...
        tableData.value[8].content =
          info.value.authorization_info.authorizer_appid;
...
<template>
  <div>
      ...
      <el-tabs tab-position="left" style="height: 650px">
        <el-tab-pane label="概况信息" class="basic">
          ...
          <el-row :gutter="20">
            ...
            >
              ...
              <div>
                <el-button @click="addshouquan" type="success"
                  >已有小程序，立即授权</el-button
                >
                ...
                <div>
                  <div style="margin: 60px; display: flex">
                    ...
                    >
                      ...
                      <img
                        src=""
                        style="height: 168px; width: 168px; margin-top: 20px"
                      />
                    </div>
                    ...
                    >
                      ...
                      <img
                        :src="info.authorizer_info.qrcode_url"
                        style="height: 168px; width: 168px; margin-top: 20px"
                      />
                    </div>
                    ...
                    <div v-else>
                      <div v-if="scope.row.content">
                        ...
                        <div v-else-if="scope.row.title == '认证状态'">
                          <div
                            v-if="scope.row.content == 1"
                            style="color: #2ba245; font-weight: bold"
                          >
                            已认证
                          </div>
                        </div>
                        ...
                        <div v-else-if="scope.row.title == '微信支付'">
                          <div
                            v-if="scope.row.content.open_pay == 1"
                            style="color: #2ba245; font-weight: bold"
                          >
                            已开启支付
                          </div>
                      ...
                      <div v-else style="color: #ccc">暂未设置</div>
                    </div>
                  </div>
                </template>
              </el-table-column>
        ...
        <el-tab-pane label="体验成员" class="security">
          ...
          <div class="setting-list">
            <el-button size="small" :icon="Plus" @click="addCy"
              >添加体验成员</el-button
            >
            <div
              style="
                ...
                <div style="display: flex; flex-wrap: wrap">
                  ...
                  >
                    <div style="display: flex">
                      <div>
                        <img
                          src="https://wx.qlogo.cn/mmhead/Q3auHgzwzM5ISSxogpkMhRQaznGRwCDkBJ1VOGicQQpJrLIle9hpARQ/0"
                          alt=""
                      ...
                      >
                        <div>自己</div>
                        <div style="color: #ccc">den******an20</div>
                        <div style="color: #ccc">2023-02-28</div>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <el-dialog v-model="dialogVisible" title="小程序授权" width="30%">
      <div
        style="
          height: 60px;
          display: flex;
