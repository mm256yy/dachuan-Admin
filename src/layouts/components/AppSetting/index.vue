...
<template>
  <div>
    <el-drawer v-model="isShow" title="应用配置" direction="rtl" :size="360">
      ...
      <div class="theme">
        <div data-theme="default" :class="{ active: settingsStore.settings.app.theme === 'default' }" @click="settingsStore.settings.app.theme = 'default'">
          <div class="content" />
        </div>
        <div data-theme="sys_green" :class="{ active: settingsStore.settings.app.theme === 'sys_green' }" @click="settingsStore.settings.app.theme = 'sys_green'">
          <div class="content" />
        </div>
        <div data-theme="sys_orange" :class="{ active: settingsStore.settings.app.theme === 'sys_orange' }" @click="settingsStore.settings.app.theme = 'sys_orange'">
          <div class="content" />
        </div>
        <div data-theme="sys_pink" :class="{ active: settingsStore.settings.app.theme === 'sys_pink' }" @click="settingsStore.settings.app.theme = 'sys_pink'">
          <div class="content" />
        </div>
        <div data-theme="sys_grey" :class="{ active: settingsStore.settings.app.theme === 'sys_grey' }" @click="settingsStore.settings.app.theme = 'sys_grey'">
          <div class="content" />
        </div>
        <div data-theme="sys_yellow" :class="{ active: settingsStore.settings.app.theme === 'sys_yellow' }" @click="settingsStore.settings.app.theme = 'sys_yellow'">
          <div class="content" />
        </div>
      </div>
      ...
      <div class="menu-style">
        <el-radio-group v-model="settingsStore.settings.menu.menuActiveStyle" size="default" :disabled="settingsStore.settings.menu.menuMode === 'single'">
          <el-tooltip content="默认" placement="top" :show-after="500">
            <el-radio-button label="">
              <el-icon size="18px">
                <svg-icon name="i-jam:stop-sign" />
          ...
          <el-tooltip content="箭头" placement="top" :show-after="500">
            <el-radio-button label="arrow">
              <el-icon size="18px">
                <svg-icon name="i-ep:caret-left" :rotate="['head', 'only-head'].includes(settingsStore.settings.menu.menuMode) ? 90 : 0" />
              </el-icon>
            </el-radio-button>
          </el-tooltip>
          <el-tooltip content="线条" placement="top" :show-after="500">
            <el-radio-button label="line">
              <el-icon size="18px">
                <svg-icon name="i-ep:semi-select" :rotate="['side', 'only-side'].includes(settingsStore.settings.menu.menuMode) ? 90 : 0" />
              </el-icon>
            </el-radio-button>
          </el-tooltip>
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.menu.switchMainMenuAndPageJump" size="default" :disabled="['single', 'only-side', 'only-head'].includes(settingsStore.settings.menu.menuMode)" />
      </div>
      <div class="setting-item">
        <div class="label">
          次导航自动隐藏
        ...
        <el-switch v-model="settingsStore.settings.menu.subMenuOnlyOneHide" size="default" :disabled="['single', 'only-side', 'only-head'].includes(settingsStore.settings.menu.menuMode)" />
      </div>
      <div class="setting-item">
        <div class="label">
          次导航保持展开一个
        ...
        <el-switch v-model="settingsStore.settings.menu.subMenuUniqueOpened" size="default" :disabled="['only-side', 'only-head'].includes(settingsStore.settings.menu.menuMode)" />
      </div>
      <div class="setting-item">
        <div class="label">
          次导航是否折叠
        </div>
        <el-switch v-model="settingsStore.settings.menu.subMenuCollapse" size="default" :disabled="['only-side', 'only-head'].includes(settingsStore.settings.menu.menuMode)" />
      </div>
      <div v-if="settingsStore.mode === 'pc'" class="setting-item">
        <div class="label">
          显示次导航折叠按钮
        </div>
        <el-switch v-model="settingsStore.settings.menu.enableSubMenuCollapseButton" size="default" :disabled="['only-side', 'only-head'].includes(settingsStore.settings.menu.menuMode)" />
      </div>
      <div class="setting-item">
        <div class="label">
          是否启用快捷键
        </div>
        <el-switch v-model="settingsStore.settings.menu.enableHotkeys" size="default" :disabled="['single', 'only-side', 'only-head'].includes(settingsStore.settings.menu.menuMode)" />
      </div>
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.topbar.switchTabbarAndToolbar" size="default" :disabled="!settingsStore.settings.tabbar.enable" />
      </div>
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.tabbar.enable" size="default" />
      </div>
      <div class="setting-item">
        <div class="label">
          风格
        </div>
        <el-radio-group v-model="settingsStore.settings.tabbar.style" size="small" :disabled="!settingsStore.settings.tabbar.enable">
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.tabbar.enableIcon" size="default" :disabled="!settingsStore.settings.tabbar.enable" />
      </div>
      <div class="setting-item">
        <div class="label">
          标签页合并规则
        </div>
        <el-select v-model="settingsStore.settings.tabbar.mergeTabsBy" size="small" :disabled="!settingsStore.settings.tabbar.enable" style="width: 150px;">
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.tabbar.enableHotkeys" size="default" :disabled="!settingsStore.settings.tabbar.enable" />
      </div>
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.toolbar.enableNotification" size="default" />
      </div>
      <div class="setting-item">
        <div class="label">
          国际化
        </div>
        <el-switch v-model="settingsStore.settings.toolbar.enableI18n" size="default" />
      </div>
      <div v-if="settingsStore.mode === 'pc'" class="setting-item">
        <div class="label">
          全屏
        ...
        <el-switch v-model="settingsStore.settings.toolbar.enableFullscreen" size="default" />
      </div>
      <div class="setting-item">
        <div class="label">
          页面刷新
        ...
        <el-switch v-model="settingsStore.settings.toolbar.enablePageReload" size="default" />
      </div>
      <div class="setting-item">
        <div class="label">
          颜色主题
        ...
        <el-switch v-model="settingsStore.settings.toolbar.enableColorScheme" size="default" />
      </div>
      <el-divider v-if="settingsStore.mode === 'pc'">
        面包屑导航
      </el-divider>
      <div v-if="settingsStore.mode === 'pc'" class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.breadcrumb.enable" size="default" />
      </div>
      <div v-if="settingsStore.mode === 'pc'" class="setting-item">
        <div class="label">
          风格
        </div>
        <el-radio-group v-model="settingsStore.settings.breadcrumb.style" size="small" :disabled="!settingsStore.settings.breadcrumb.enable">
          <el-radio-button label="">
            默认
          </el-radio-button>
      ...
      <div v-if="settingsStore.mode === 'pc'" class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.breadcrumb.enableMainMenu" size="default" :disabled="!settingsStore.settings.breadcrumb.enable || ['single'].includes(settingsStore.settings.menu.menuMode)" />
      </div>
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.mainPage.enableHotkeys" size="default" />
      </div>
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.navSearch.enable" size="default" />
      </div>
      <div class="setting-item">
        <div class="label">
          是否启用快捷键
        </div>
        <el-switch v-model="settingsStore.settings.navSearch.enableHotkeys" size="default" :disabled="!settingsStore.settings.navSearch.enable" />
      </div>
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.copyright.enable" size="default" />
      </div>
      <div class="setting-item">
        <div class="label">
          日期
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.home.enable" size="default" />
      </div>
      <div class="setting-item">
        <div class="label">
          主页名称
        ...
        <el-input v-model="settingsStore.settings.home.title" size="small" :disabled="settingsStore.settings.toolbar.enableI18n" />
      </div>
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.app.enablePermission" size="default" />
      </div>
      <div class="setting-item">
        <div class="label">
          载入进度条
        ...
        <el-switch v-model="settingsStore.settings.app.enableProgress" size="default" />
      </div>
      <div class="setting-item">
        <div class="label">
          动态标题
        ...
        <el-switch v-model="settingsStore.settings.app.enableDynamicTitle" size="default" />
      </div>
      <div class="setting-item">
        <div class="label">
          Storage 前缀
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.app.enableWatermark" size="default" />
      </div>
      <template v-if="isSupported" #footer>
        <el-button type="primary" size="default" @click="handleCopy">
          <template #icon>
            <el-icon>
