...
<template>
  <div>
    <el-drawer v-model="isShow" title="快捷键介绍" direction="rtl" :size="360">
      ...
      <el-descriptions v-if="settingsStore.settings.tabbar.enable && settingsStore.settings.tabbar.enableHotkeys" title="标签栏" :column="1" border>
      ...
      <el-descriptions v-if="settingsStore.settings.mainPage.enableHotkeys" title="页面" :column="1" border>
